    ...
    <div v-if="parentComponent === 'item'">
      <div class="item_back item_container_style">
        <div class="item_list_container" v-if="questionList.length">
          ...
          <ul>
            <li class="item_list" v-for="(item, index) in questionList[itemNum - 1].topic_answer" :key="item.topic_answer_id"
...
export default {
  props: ['parentComponent'],  // 子组件接受父组件传过来的值
  computed: mapState(['questionList', 'itemNum']),  // 将仓库中的数据questionList拿出来
  data() {
    return {
